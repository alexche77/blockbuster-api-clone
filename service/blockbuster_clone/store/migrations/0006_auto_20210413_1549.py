    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movement_type', models.IntegerField(choices=[(1, 'Sale'), (2, 'Rent'), (3, 'Rent Return'), (4, 'Defective Return'), (5, 'Purchase'), (6, 'Adjustment')])),
                ('quantity', models.IntegerField(default=1)),
                ('comments', models.CharField(max_length=255)),
                ('price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
